...
exports.getFrameData = exports.cancelSync = undefined;
...
},{"hey-listen":15,"process":11}],14:[function(require,module,exports) {
'use strict';
...
var _framesync2 = _interopRequireDefault(_framesync);
    ...
    return function (props) {
        ...
        var setValue = function (unmappedKey, value) {
            ...
            if (state[key] !== currentValue) {
                ...
                if (!hasChanged) {
                    hasChanged = true;
                    _framesync2.default.render(render);
                }
            }
        };
...
},{"framesync":13,"style-value-types":14,"tslib":12,"hey-listen":15}],7:[function(require,module,exports) {
var process = require("process");
'use strict';
...
exports.ValueReaction = exports.Action = exports.svg = exports.css = exports.transform = exports.calc = exports.stagger = exports.schedule = exports.parallel = exports.merge = exports.delay = exports.crossfade = exports.composite = exports.chain = exports.multitouch = exports.mouse = exports.pointer = exports.listen = exports.tween = exports.timeline = exports.spring = exports.physics = exports.everyFrame = exports.keyframes = exports.decay = exports.value = exports.multicast = exports.action = exports.styler = exports.easing = exports.valueTypes = undefined;
...
var ValueReaction = /*#__PURE__*/function (_super) {
    ...
    function ValueReaction(props) {
        ...
        _this.scheduleVelocityCheck = function () {
            return _framesync2.default.postRender(_this.velocityCheck);
        };
    ...
    ValueReaction.prototype.update = function (v) {
        ...
        _framesync2.default.postRender(this.scheduleVelocityCheck);
    };
                ...
                return a.start({
                    complete: function () {
                        if (!hasCompleted) {
                            hasCompleted = true;
                            numCompletedActions++;
                            if (numCompletedActions === numActions) _framesync2.default.update(complete);
                        }
                    },
                    error: error,
                    update: function (v) {
                        setProp(output, name, v);
                        _framesync2.default.update(updateOutput, false, true);
                    }
                });
            });
...
var decay = function (props) {
    ...
    return action(function (_a) {
        ...
        var process = _framesync2.default.update(function (_a) {
...
var tween = function (props) {
    ...
    return action(function (_a) {
        ...
        var startTimer = function () {
            isActive = true;
            process = _framesync2.default.update(function (_a) {
                var delta = _a.delta;
                elapsed += delta * playDirection;
                updateTween();
                if (isTweenComplete() && complete) {
                    _framesync.cancelSync.update(process);
                    _framesync2.default.update(complete, false, true);
                }
            }, true);
        };
        ...
        return {
            ...
            seek: function (newProgress) {
                ...
                _framesync2.default.update(updateTween, false, true);
                return this;
            },
            reverse: function () {
                reverseTween();
...
var defaultEasings = function (values, easing$$1) {
    return values.map(function () {
        return easing$$1 || _easing.easeOut;
...
var multitouch = function (_a) {
    ...
    return action(function (_a) {
        ...
        var onMove = function (e) {
            ...
            _framesync2.default.update(updatePoint);
        };
        var updateOnMove = listen(document, 'touchmove', {
            passive: !preventDefault
        }).start(onMove);
        if (isTouchDevice) _framesync2.default.update(updatePoint);
        return {
            stop: function () {
...
var mouse = function (_a) {
    ...
    return action(function (_a) {
        ...
        if (isMouseDevice) _framesync2.default.update(updatePoint);
        return {
            stop: function () {
                _framesync.cancelSync.update(updatePoint);
                updateOnMove.stop();
...
},{"tslib":12,"framesync":13,"style-value-types":14,"hey-listen":15,"@popmotion/easing":18,"stylefire":17,"process":11}],3:[function(require,module,exports) {
...
},{"popmotion":7}],25:[function(require,module,exports) {
...
//# sourceMappingURL=/animation.3325878c.map